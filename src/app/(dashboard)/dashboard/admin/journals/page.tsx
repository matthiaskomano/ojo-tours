  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Editorial</h1>
          <p className="text-sm text-gray-500 mt-2">Manage your journal articles and blog posts</p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Read Time</th>
                  ...
                  <tr key={journal.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <img src={journal.image} alt={journal.title} className="w-16 h-16 rounded-lg object-cover" />
                        <div>
                          <div className="font-medium text-gray-900">{journal.title}</div>
                          <div className="text-sm text-gray-500 line-clamp-1">{journal.excerpt.substring(0, 50)}...</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-600">{journal.author}</div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-600">{journal.readTime}</div>
                    </td>
                    <td className="px-6 py-4">
                      {journal.featured ? (
