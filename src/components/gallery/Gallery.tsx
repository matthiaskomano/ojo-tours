    ...
    <section className="py-32 bg-safari-green relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {categories.map((category) => (
            <button
              ...
              className={`text-xs tracking-[0.2em] cursor-pointer uppercase font-bold transition-all duration-300 relative pb-4 -mb-[17px] ${
        ...
        {isLoading ? (
          ...
          <motion.div
            layout
            className="grid grid-cols-1 md:grid-cols-4 auto-rows-[250px] md:auto-rows-[300px] gap-4 md:gap-6"
          >
            <AnimatePresence>
              {filteredImages.map((image) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-safari-green via-safari-green/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        >
          <button className="bg-transparent border border-gold/50 hover:border-gold hover:bg-gold hover:text-safari-green text-gold px-10 py-4 rounded-full font-bold tracking-[0.2em] uppercase text-xs transition-all duration-500 shadow-[0_0_20px_rgba(212,175,55,0.1)] hover:shadow-[0_0_30px_rgba(212,175,55,0.3)] cursor-pointer">
