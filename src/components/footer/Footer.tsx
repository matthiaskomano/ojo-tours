        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8 max-w-sm">
              Curating high-end Rwandan expeditions with a commitment to conservation and uncompromised luxury.
            </p>
            <div className="flex space-x-3">
              {[InstagramIcon, FacebookIcon, TwitterIcon, LinkedInIcon].map((Icon, i) => (
                <a key={i} href="#" className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-white/40 hover:bg-gold hover:text-safari-green hover:border-gold transition-all duration-300">
                  <Icon />
                </a>
              ))}
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {['Destinations', 'Safari Packages', 'Luxury Lodges', 'Our Story', 'Journal'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-white/40 hover:text-gold transition-colors text-sm font-light flex items-center group">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <p className="text-white/50 text-sm font-light">KG 7 Avenue, Heights Tower, Kigali City</p>
              </div>
              <div className="flex items-center gap-4">
                <Phone size={16} className="text-gold shrink-0" />
                <p className="text-white/50 text-sm font-light">+250 788 000 000</p>
              </div>
              <div className="flex items-center gap-4">
                <Mail size={16} className="text-gold shrink-0" />
                <p className="text-white/50 text-sm font-light">concierge@ojotours.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
              ...
              />
              <button className="w-full bg-transparent border border-gold text-gold hover:bg-gold hover:text-[#040C08] font-bold py-3 rounded-lg transition-all text-[10px] tracking-[0.2em] uppercase flex items-center justify-center gap-2 group">
                Subscribe <Send size={12} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            {['Privacy', 'Terms', 'Sitemap'].map((item) => (
              <a key={item} href="#" className="text-white/30 hover:text-gold text-[10px] tracking-widest uppercase transition-colors">
                {item}
              </a>
            ))}
          </div>
