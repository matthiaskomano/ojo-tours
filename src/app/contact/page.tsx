...
import { MapPin, Phone, Mail, MessageCircle, Send, Loader2, CheckCircle, Clock } from "lucide-react";
    ...
    <main className="min-h-screen bg-safari-green selection:bg-gold selection:text-safari-green pb-0">
      ...
      <section className="relative h-[55vh] min-h-[450px] flex items-center justify-center overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-safari-green via-safari-green/80 to-safari-green/30" />
        </div>
        ...
        <div className="relative z-10 text-center px-6 mt-20">
          ...
          >
            Whether you are ready to book a bespoke safari or simply have a question about Rwanda, our luxury travel experts are at your service round the clock.
          </motion.p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="bg-safari-emerald/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 lg:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative overflow-hidden">
              ...
              <h3 className="text-2xl font-serif text-white mb-8">Headquarters</h3>
              ...
              <div className="space-y-8 relative z-10">
                <div className="flex items-start group">
                  ...
                  <div>
                    <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] block mb-1">Office Location</span>
                    <p className="text-white/80 font-light leading-relaxed">
                      KG 7 Avenue, Heights Tower<br />
                      Kigali City, Rwanda
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] block mb-1">Direct Line</span>
                    <p className="text-white/80 font-light leading-relaxed">+250 788 000 000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] block mb-1">Email Us</span>
                    <p className="text-white/80 font-light leading-relaxed">concierge@ojotours.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <span className="text-white/40 text-[10px] uppercase tracking-[0.2em] block mb-1">Operating Hours</span>
                    <p className="text-white/80 font-light leading-relaxed">
                      Mon - Fri: 8:00 AM - 6:00 PM<br />
                      <span className="text-white/50 text-sm">24/7 Support for Active Guests</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  <MessageCircle size={18} className="mr-3 group-hover:scale-110 transition-transform" /> Chat on WhatsApp
                </a>

                <div className="flex items-center justify-between px-2">
                  <span className="text-white/40 text-[10px] uppercase tracking-[0.2em]">Follow Our Journey</span>
                  <div className="flex space-x-4">
                    <a href="#" className="text-white/40 hover:text-gold hover:scale-110 transition-all"><InstagramIcon size={20} /></a>
                    <a href="#" className="text-white/40 hover:text-gold hover:scale-110 transition-all"><FacebookIcon size={20} /></a>
                    <a href="#" className="text-white/40 hover:text-gold hover:scale-110 transition-all"><TwitterIcon size={20} /></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-[300px] w-full rounded-3xl overflow-hidden border border-white/10 group shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
              <iframe 
                ...
                width="100%" 
                height="100%" 
                style={{ border: 0, filter: "grayscale(100%) invert(90%) contrast(1.2) opacity(0.8)" }} 
              ...
              {isSubmitSuccessful ? (
                ...
                >
                  ...
                  <p className="text-white/60 leading-relaxed mb-10 max-w-md mx-auto font-light text-lg">
                    Thank you for reaching out to OJO Tours. Our concierge team has received your message and will respond to your inquiry shortly.
                  </p>
                  <button 
                ...
                <>
                  <div className="mb-10">
                    <h2 className="text-4xl font-serif text-white mb-3">Send an Inquiry</h2>
                    <p className="text-white/50 text-base font-light">Fill out the form below and a dedicated travel specialist will get back to you within 24 hours.</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] text-white/50 uppercase tracking-[0.2em] ml-1">Full Name</label>
                        <input 
                          {...register("fullName")}
                          type="text" 
                        ...
                        />
                        {errors.fullName && <p className="text-red-400 text-[10px] ml-1 mt-1">{errors.fullName.message}</p>}
                      </div>

                      {/* Email */}
                      <div className="space-y-2">
                        <label className="text-[10px] text-white/50 uppercase tracking-[0.2em] ml-1">Email Address</label>
                        <input 
                          {...register("email")}
                          type="email" 
                        ...
                        />
                        {errors.email && <p className="text-red-400 text-[10px] ml-1 mt-1">{errors.email.message}</p>}
                      </div>
                    </div>

                    {/* Subject Dropdown */}
                    <div className="space-y-2">
                      <label className="text-[10px] text-white/50 uppercase tracking-[0.2em] ml-1">Subject</label>
                      <select 
                        {...register("subject")}
                        defaultValue=""
                      ...
                      >
                        <option value="" disabled className="bg-[#0A1A12]">How can we assist you?</option>
                        <option value="General Inquiry" className="bg-[#0A1A12]">General Inquiry</option>
                        <option value="Custom Tour Request" className="bg-[#0A1A12]">Custom Tour Request</option>
                        <option value="Partnership" className="bg-[#0A1A12]">Business Partnership</option>
                        <option value="Press" className="bg-[#0A1A12]">Media & Press</option>
                      </select>
                      {errors.subject && <p className="text-red-400 text-[10px] ml-1 mt-1">{errors.subject.message}</p>}
                    </div>

                    {/* Message */}
                    <div className="space-y-2">
                      <label className="text-[10px] text-white/50 uppercase tracking-[0.2em] ml-1">Your Message</label>
                      <textarea 
                        {...register("message")}
                        rows={6}
                      ...
                      />
                      {errors.message && <p className="text-red-400 text-[10px] ml-1 mt-1">{errors.message.message}</p>}
                    </div>
                    ...
                    <button 
                      ...
                      className="flex justify-center items-center bg-gold hover:bg-[#F1D592] disabled:bg-gold/30 disabled:text-safari-green/50 disabled:cursor-not-allowed text-[#040C08] font-bold px-10 py-5 rounded-xl transition-all duration-500 text-xs tracking-[0.2em] uppercase mt-8 shadow-[0_0_20px_rgba(212,175,55,0.2)] hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transform hover:-translate-y-1 w-full md:w-auto"
                    >
                      {isSubmitting ? (
                        <>
                          <Loader2 size={16} className="animate-spin mr-3" /> Transmitting...
                        </>
                      ) : (
                        <>
