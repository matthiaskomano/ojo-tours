...
export default function LodgesPage() {
  ...
  const renderAmenityIcon = (amenityString: string) => {
    ...
    if (lower.includes("wine") || lower.includes("bar"))
      return <GlassWater size={14} />;
    if (lower.includes("butler") || lower.includes("service"))
      return <User size={14} />;
    if (
      ...
      <div className="grow w-full">
        ...
        <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 mt-20 max-w-4xl mx-auto">
            ...
            >
              Sanctuaries in{" "}
              <span className="italic text-[#F1D592]">The Wild</span>
            </motion.h1>
            ...
            >
              After a day of thrilling encounters, retreat to Rwanda's most
              exclusive lodges. Expect world-class gastronomy, private infinity
              pools, and uncompromised luxury.
            </motion.p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
              {[
                {
                  title: "Eco-Conscious",
                  desc: "100% sustainable operations leaving zero footprint.",
                },
                {
                  title: "Absolute Privacy",
                  desc: "Exclusive-use villas hidden deep within nature.",
                },
                {
                  title: "Curated Gastronomy",
                  desc: "Farm-to-table dining crafted by master chefs.",
                },
              ].map((item, idx) => (
            ...
            {lodges.length === 0 && (
              <div className="text-center py-20 border border-white/10 rounded-[2rem] bg-white/5">
                ...
                <p className="text-white/50">
                  Check back soon as we curate our luxury collection.
                </p>
              </div>
            )}
            ...
            {lodges.map((lodge, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`w-full lg:w-[50%] z-10 mt-8 lg:mt-0 ${isEven ? "lg:-ml-20" : "lg:-mr-20"}`}
                  >
                    <div className="bg-[#1B3022]/90 backdrop-blur-xl border border-white/10 p-8 md:p-12 lg:p-16 rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.4)]">
                      ...
                      {lodge.amenities && lodge.amenities.length > 0 && (
                        <div className="space-y-6 mb-12">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            {lodge.amenities.map(
                              (amenityStr: string, idx: number) => (
                                <div
                                  key={idx}
                                  className="flex items-center text-white/80 text-sm font-light"
                                >
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <a
                          href={`mailto:bookings@ojotours.com?subject=Inquiry regarding ${lodge.name}`}
                          className="bg-gold bg-[#F1D592] text-[#0A1A12] px-8 py-4 rounded-full font-bold tracking-[0.2em] uppercase text-xs transition-all duration-500 shadow-[0_0_20px_rgba(212,175,55,0.2)] text-center w-full sm:w-auto"
                        >
                          Inquire Now
                        </a>
                      </div>
