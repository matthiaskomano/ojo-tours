      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl">
            ...
            >
              Featured <span className="italic text-[#F1D592]">Destinations</span>
            </motion.h2>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-32 bg-[#040C08]/50 border border-white/5 border-dashed rounded-3xl">
            <p className="text-white/50">No tours found. Add your first tour in the Admin Dashboard!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="relative h-80 overflow-hidden">
                  <div className="absolute top-6 right-6 z-20 bg-[#0A1A12]/90 backdrop-blur-md px-4 py-2 rounded-full flex items-center border border-white/10 shadow-2xl">
                    ...
                    <span className="text-white text-xs font-bold tracking-wider">{tour.rating}</span>
                  </div>
                ...
                {/* Card Content */}
                <div className="p-8 md:p-10 flex flex-col flex-grow relative z-20 -mt-12">
                  <div className="mb-6">
                  ...
                  <div className="flex items-end justify-between pt-2">
                    <div>
                      <span className="text-white/40 text-[9px] uppercase tracking-[0.2em] block mb-1.5">Starting from</span>
                      <p className="text-3xl text-white font-serif">{tour.price}</p>
                    </div>
                    <a href={`/tours/${tour.id}`} className="bg-transparent border border-white/20 text-white hover:border-gold hover:bg-gold hover:text-[#0A1A12] px-8 py-3.5 rounded-full text-[10px] tracking-[0.2em] uppercase font-bold transition-all duration-500">
                      Discover
                    </a>
                  </div>
                </div>
        ...
        >
          <a href="/tours" className="inline-block bg-transparent border border-white/20 text-white hover:border-gold hover:text-gold px-10 py-4 rounded-full font-bold tracking-widest uppercase text-xs transition-all duration-300">
            View All Journeys
          </a>
        </motion.div>
