...
export default function JournalPage() {
  ...
  return (
    <main className="min-h-screen bg-safari-green selection:bg-gold selection:text-safari-green flex flex-col">
      <div className="grow w-full pb-24">
        {/* Cinematic Header */}
        <section className="relative pt-48 pb-20 px-6 border-b border-white/5">
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              Curated perspectives on luxury travel, wildlife conservation, and
              the vibrant culture of the Land of a Thousand Hills.
            </motion.p>
          </div>
        </section>
            ...
            <div className="flex items-center gap-6 md:gap-10 min-w-max">
              {categories.map((category) => (
                <button
                  ...
                  className={`text-[10px] md:text-xs cursor-pointer tracking-[0.2em] uppercase font-bold transition-all duration-300 relative py-2 ${
                  ...
                  {regularPosts.map((post, index) => (
                    ...
                    >
                      <div className="relative h-64 overflow-hidden rounded-2xl mb-6 border border-white/10">
                        ...
                        />
                        <div className="absolute inset-0 bg-linear-to-t from-safari-green via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      </div>
                      ...
                      <div className="flex items-center text-white/40 text-[10px] tracking-widest uppercase mb-4 space-x-4">
                        ...
                        <span>•</span>
                        <span className="flex items-center">
                          <Calendar size={10} className="mr-1.5" /> Recently
                          Added
                        </span>
                      </div>
        ...
        <section className="max-w-5xl mx-auto px-6 mt-32">
          <div className="bg-[#0a1a12] border border-gold/20 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <p className="text-white/60 font-light mb-10 max-w-lg mx-auto">
              Receive exclusive travel guides, conservation updates, and
              priority access to our newest luxury itineraries.
            </p>
            <form
