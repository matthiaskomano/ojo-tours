    ...
    <main className="min-h-screen bg-safari-green selection:bg-gold selection:text-safari-green pb-0 overflow-hidden">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-leaner-to-t from-safari-green via-safari-green/80 to-transparent" />
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 -mt-20 relative z-20 mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-leaner-to-t from-safari-green/80 to-transparent" />
          </motion.div>
          ...
          >
            <h2 className="text-3xl md:text-5xl font-serif text-white mb-8 leading-tight">
              Born from a Love <br />
              <span className="italic text-gold">for the Wild</span>
            </h2>
            <div className="space-y-6 text-white/70 text-lg font-light leading-relaxed">
              <p>
                OJO Tours & Safaris was founded on a simple, yet profound
                principle: to share the unparalleled beauty of Rwanda with the
                world, while fiercely protecting the ecosystems that make it so
                special.
              </p>
              <p>
                Headquartered in the vibrant heart of Kigali, our team knows
                every hidden trail of Volcanoes National Park and every watering
                hole in Akagera. We are not just tour operators; we are
              ...
              <blockquote className="border-l-2 border-gold pl-6 py-4 my-8 text-xl font-serif text-white/90 italic bg-white/5 rounded-r-xl pr-4 backdrop-blur-sm shadow-inner">
                "To travel with OJO is to experience Rwanda not as a tourist,
                but as an honored guest of the land."
              </blockquote>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-safari-emerald/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-leaner-to-br from-gold/20 to-transparent flex items-center justify-center mb-8 border border-gold/20 group-hover:scale-110 transition-transform duration-500">
              ...
              <p className="text-white/60 text-lg leading-relaxed font-light">
                To curate extraordinary, bespoke safari experiences that exceed
                the expectations of the modern luxury traveler, while actively
                contributing to the conservation of Rwanda's wildlife and the
                prosperity of its local communities.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/60 text-lg leading-relaxed font-light">
                To be universally recognized as East Africa’s premier luxury
                tourism provider, setting the global standard for ethical,
                high-end travel and ensuring the "Land of a Thousand Hills"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 text-center">
            {[
              ...
              >
                ...
                <h4 className="text-4xl md:text-5xl font-serif text-white mb-3">
                  {item.stat}
                </h4>
                <p className="text-white/50 text-xs tracking-[0.2em] uppercase font-bold">
                  {item.label}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-32 bg-[#06110c] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-gold tracking-[0.4em] uppercase text-xs font-bold mb-4">
              The Visionaries
            </h2>
            <h3 className="text-4xl md:text-5xl font-serif text-white">
              Meet the <span className="italic text-gold-light">Directors</span>
            </h3>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <h4 className="text-2xl font-serif text-white mb-1 group-hover:text-gold-light transition-colors">
                    {member.name}
                  </h4>
                  <p className="text-gold text-[10px] tracking-widest uppercase mb-4 font-bold">
                    {member.role}
                  </p>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-white/70 text-lg md:text-xl font-light leading-relaxed mb-10">
            Rwanda is widely considered the crown jewel of East Africa. A nation
            of stunning rebirth and pristine natural beauty, it offers the
            safest, cleanest, and most exclusive safari experiences on the
            continent. From the thriving capital of Kigali to the majestic
            Virunga mountain range, every inch of this country pulses with life.
          </p>
          <a
            href="/tours"
            className="inline-block bg-transparent border border-gold hover:bg-gold hover:text-safari-green text-gold px-10 py-4 rounded-full font-bold tracking-[0.2em] uppercase text-xs transition-all duration-500 shadow-lg"
          >
